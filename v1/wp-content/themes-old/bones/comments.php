...
<?php if ( have_comments() ) : ?>
	<h3 id="comments" class="h2"><i class="icon-comments"></i> <?php comments_number(__('<span>No</span> Responses', 'bonestheme'), __('<span>One</span> Response', 'bonestheme'), _n('<span>%</span> Response', '<span>%</span> Responses', get_comments_number(),'bonestheme') );?></h3>
...
<section id="respond" class="respond-form">
	...
	<ul id="comment-form-elements" class="clearfix line">
	...
	<div class="avatar unit">
	 ...
	 <div class="lastUnit">
		...
		<input name="submit" type="submit" id="submit" class="btn pull-right" style="margin-right: 15px;" tabindex="5" value="<?php _e('Post Comment', 'bonestheme'); ?>" />
