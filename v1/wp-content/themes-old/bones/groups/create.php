	...
	<div id="content" class="wrapped-content">
		...
		<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
			<div class="page_header">
				<h1><a href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() ); ?>">Groups</a>
			...
			<div class="item-body line" id="group-create-body">

				<div class="item-list-tabs no-ajax" id="group-create-tabs" role="navigation">
					<ul class="breadcrumb">
						<?php my_bp_group_creation_tabs(); ?>
					</ul>
				</div>
			...
			<?php do_action( 'template_notices' ); ?>
				...
				<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
					...
					<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<div class="main-column lastUnit">
							...
							<p>
								...
								<button class="btn btn-info" type="submit" name="upload" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ); ?>" ><?php _e( 'Upload Image', 'buddypress' ); ?> <i class="icon-upload-alt"></i></button>
					...
					<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<button class="btn btn-success" type="submit" name="avatar-crop-submit" id="avatar-crop-submit" value="<?php _e( 'Crop Image', 'buddypress' ); ?>" ><?php _e( 'Crop Image', 'buddypress' ); ?> <i class="icon-thumbs-up"></i></button>
				...
				<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
					...
					<div class="submit line" id="previous-next">

						<?php /* Previous Button */ ?>
						<?php if ( !bp_is_first_group_creation_step() ) : ?>

							<button class="btn btn-large" type="button" value="<?php _e( 'Back to Previous Step', 'buddypress' ); ?>" id="group-creation-previous" name="previous" onclick="location.href='<?php bp_group_creation_previous_link(); ?>'" ><i class="icon-arrow-left"></i> <?php _e( 'Previous Step', 'buddypress' ); ?></button>
						...
						<?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
							...
							<button class="btn btn-large btn-success" type="submit" value="<?php _e( 'Next Step', 'buddypress' ); ?>" id="group-creation-next" name="save" ><?php _e( 'Next Step', 'buddypress' ); ?> <i class="icon-arrow-right"></i></button>
						...
						<?php if ( bp_is_first_group_creation_step() ) : ?>
							...
							<button class="btn btn-large btn-success" type="submit" value="<?php _e( 'Create Group and Continue', 'buddypress' ); ?>" id="group-creation-create" name="save" ><?php _e( 'Create Group and Continue', 'buddypress' ); ?> <i class="icon-arrow-right"></i></button>
						...
						<?php if ( bp_is_last_group_creation_step() ) : ?>
							...
							<button class="btn btn-large btn-success" type="submit" value="<?php _e( 'Finish', 'buddypress' ); ?>" id="group-creation-finish" name="save" ><?php _e( 'Finish', 'buddypress' ); ?></button>
