<?php
/*
Template Name: News Categories List
*/
?>
				...
				<div id="inner-content" class="wrap clearfix">
					<div id="main" class="unit" role="main">
						...
						<div class="groups-wrapper">
							<?php
								$terms = get_terms('news-category', array('hide_empty' => false));
							...
							?>
								<div class='group-wrapper'><div class='group'>
									<a href="<?php echo site_url(); ?>/news-category/<?php echo $term->slug; ?>"><strong><?php echo $term->slug; ?></strong><span class="pull-right"><?php echo $article_count; ?></span>
							...
							<?php
								  if ($article_count) {
									 ...
									 endwhile;
									 echo '</ul> <a href="'.site_url().'/help-category/'.$term->slug.'">Read More</a>';
								  }
								  ?>
									</div></div>
							<?php	}
