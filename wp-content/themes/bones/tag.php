...
get_header(); ?>
	...
	<section id="primary" class="site-content help">
		<div id="content" role="main">
			<div class="wrap clear-fix" id="inner-content">
				...
				<header class="archive-header line">
					<h3 class="archive-title pull-left">Articles tagged: <span><i class="icon-tags"></i> <?php printf(  single_cat_title( '', false )); ?></span></h3>
			...
			<?php if ( have_posts() ) : 
				...
				while ( have_posts() ) : the_post(); ?>
					<li class="line">
						<a href="<?php the_permalink(); ?>" class="unit size3of5">
							<strong><?php the_title(); ?></strong>
							<span><?php the_date(''); ?></span>															
						</a>
						<div class="unit size2of5 tag-list"><i class="icon-tags"></i> <?php the_tags('', ''); ?></div>
					</li>
				<?php
				endwhile;
				echo "</ul>";
