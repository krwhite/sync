...
<li id="acomment-<?php bp_activity_comment_id(); ?>" class="line">
	<div class="acomment-avatar unit">
	...
	<div class="lastUnit">
		<div class="acomment-meta">
			...
			printf( __( '<a href="%1$s" class="username">%2$s</a> replied <a href="%3$s" class="activity-time-since pull-right"><span class="time-since">%4$s</span></a>', 'buddypress' ), bp_get_activity_comment_user_link(), bp_get_activity_comment_name(), bp_get_activity_thread_permalink(), bp_get_activity_comment_date_recorded() );
			?>
		</div>
