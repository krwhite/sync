...
<div id="acomment-<?php bp_activity_comment_id(); ?>" class="line hover">
	...
	<div class="acomment-options">
		...
		<?php if ( is_user_logged_in() && bp_activity_can_comment_reply( bp_activity_current_comment() ) ) : ?>
			...
			<a href="#acomment-<?php bp_activity_comment_id(); ?>" class="acomment-reply bp-primary-action" id="acomment-reply-<?php bp_activity_id(); ?>-from-<?php bp_activity_comment_id(); ?>"><i class="icon-reply"></i> <span><?php _e( 'Reply', 'buddypress' ); ?></span></a>

		<?php endif; ?>

		<?php if ( bp_activity_user_can_delete() ) : ?>

			<a href="<?php bp_activity_comment_delete_link(); ?>" class="delete acomment-delete confirm bp-secondary-action" rel="nofollow"><i class="icon-trash"></i> <span><?php _e( 'Delete', 'buddypress' ); ?></span></a>
