		...
		<div id="buddypress">
			<div id="item-header" role="complementary">
				<div class="widget_nav_menu">
					<h3><?php _e( 'Create New Group', 'buddypress' ); ?></h3>
				</div>
			</div><!-- #item-header -->
		...
		<div class="item-body" id="group-create-body">
			...
			<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
				...
				<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
					...
					<div class="left-menu column size1of3">
						<div class="inner">
							<?php bp_new_group_avatar( 'type=full&width=100%&height=' ); ?>
						</div>
					</div><!-- .left-menu -->

					<div class="main-column column size2of3">
						...
						<p>
							...
							<button type="submit" name="upload" id="upload"><i class="icon-upload"></i> <?php _e( 'Upload Image', 'buddypress' ); ?></button>
				...
				<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
					...
					<div class="submit">
						<button type="submit" name="avatar-crop-submit" id="avatar-crop-submit"><i class="icon-thumbs-up"></i> <?php _e( 'Crop Image', 'buddypress' ); ?></button>
					</div>
